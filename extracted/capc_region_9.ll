...
define dso_local void @capc_region_9(ptr noalias noundef readnone captures(none) %0, ptr noalias noundef readnone captures(none) %1, ptr noalias noundef readnone captures(none) %2, ptr noalias noundef readnone captures(none) %3) local_unnamed_addr #0 {
  ret void
}
