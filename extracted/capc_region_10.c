...
void capc_region_10(double* restrict sigxxi, double (* restrict SXX), double (* restrict P), double* restrict sigyyi, double (* restrict SYY), double* restrict sigxyi, double (* restrict SXY), double* restrict rho2i, double (* restrict RHO), double* restrict xij, double (* restrict X), double* restrict yij, double (* restrict Y), double* restrict dist, double* restrict term1, double* restrict term12, double* restrict term2, double (* restrict VXDOT), double (* restrict MASS), double (* restrict VYDOT), double* restrict EINT, double* restrict vxij, double (* restrict VX), double* restrict vyij, double (* restrict VY), double hsq, double* restrict mata, double (* restrict wfgrad)[5], double* restrict matb, double* restrict matc, double* restrict matd, double (* restrict wf), double* restrict wf_grad, double* restrict wfdx, double* restrict wfdy, double* restrict rhobar, double* restrict drhobar, double (* restrict RHODOT), double* restrict sigxxj, double* restrict sigyyj, double* restrict sigxyj, double* restrict rho2j, double (* restrict rxydot), double (* restrict visc), double* restrict trace, double (* restrict DVXDX), double (* restrict DVYDY), double (* restrict SXXDOT), double (* restrict SYYDOT), double (* restrict SXYDOT), double (* restrict DVXDY), double (* restrict DVYDX), double (* restrict XDOT), double (* restrict VXBAR), double (* restrict YDOT), double (* restrict VYBAR), double (* restrict EDOT))
{
    int i;
    int j;
    for(i=0;i<N;i++)    {
