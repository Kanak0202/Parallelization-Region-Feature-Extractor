...
void capc_region_9(double* restrict xij, double (* restrict X), double* restrict yij, double (* restrict Y), double* restrict dist, double hsq, double (* restrict wf), double (* restrict wfgrad)[5], double (* restrict MASS), double (* restrict RHO))
{
    int i;
    int j;
    	for(i=N-NB;i<N;i++)	{
