...
void capc_region_15(double (* restrict sumKernel), double* restrict xij, double (* restrict X), double* restrict yij, double (* restrict Y), double* restrict dist, double hsq, double (* restrict wf), double (* restrict MASS), double (* restrict RHO))
{
    int i;
    int j;
    for(i=0;i<N;i++)    {
