...
#pragma omp target data map(tofrom:A[0:13000000],B[0:13000000])
...
#pragma omp target data map(to:A[0:13000000],B[0:13000000]) \
                        map(tofrom:C[0:13000000])
