...
#pragma omp target data map(to:a[0:2000][0:2000],b[0:2000][0:2000])
...
#pragma omp target data map(to:c[0:2000][0:2000],d[0:2000][0:2000])
...
#pragma omp target data map(to:e[0:2000][0:2000],f[0:2000][0:2000])
