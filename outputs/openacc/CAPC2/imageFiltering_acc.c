...
int main()
{
    ...
    #pragma capc profitability_region begin
    #pragma acc parallel loop collapse(2) \
        copyin(image[0:N][0:N]) \
        copyout(filtered[0:N][0:N])
    for (i = 0; i < N; i++)
    {
        for (j = 0; j < N; j++)
        {
    ...
    #pragma capc profitability_region begin
    #pragma acc parallel loop collapse(2) \
        copyin(filtered[0:N][0:N]) \
        copyout(enhanced[0:N][0:N])
    for (i = 0; i < N; i++)
    {
        for (j = 0; j < N; j++)
        {
    ...
    #pragma capc profitability_region begin
    #pragma acc parallel loop collapse(2) \
        copyin(enhanced[0:N][0:N]) \
        copyout(output[0:N][0:N])
    for (i = 0; i < N; i++)
    {
        for (j = 0; j < N; j++)
        {
