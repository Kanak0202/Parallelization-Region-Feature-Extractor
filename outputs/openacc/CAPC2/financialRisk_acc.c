...
int main()
{
    ...
    #pragma capc profitability_region begin
    #pragma acc parallel loop collapse(2) \
        copyin(assets[0:N][0:N]) \
        copyout(risk[0:N][0:N])
    for (i = 0; i < N; i++)
    {
        for (j = 0; j < N; j++)
        {
    ...
    #pragma capc profitability_region begin
    #pragma acc parallel loop collapse(2) \
        copyin(normalized[0:N][0:N]) \
        copyout(category[0:N][0:N])
    for (i = 0; i < N; i++)
    {
        for (j = 0; j < N; j++)
        {
    ...
    #pragma capc profitability_region begin
    #pragma acc parallel loop collapse(2) \
        copyin(normalized[0:N][0:N], category[0:N][0:N]) \
        copyout(risk[0:N][0:N])
    for (i = 0; i < N; i++)
    {
        for (j = 0; j < N; j++)
