...
int main(void)
{
    ...
    #pragma acc enter data create(E[0:13000000], A[0:13000000], B[0:13000000])
    #pragma acc wait
    ...
    #pragma acc parallel loop auto gang vector num_gangs(50782) vector_length(256) present(E[0:13000000], A[0:13000000], B[0:13000000])
        for (i = 0; i <= 12999999; i += 1) {
            E[i] = A[i] * B[i];
        }
    ...
    clock_gettime(CLOCK_MONOTONIC, &__capc_t_start);
    #pragma acc update self(E[0:13000000])
    #pragma acc wait
    clock_gettime(CLOCK_MONOTONIC, &__capc_t_end);
    ...
    #pragma acc exit data delete(E[0:13000000], A[0:13000000], B[0:13000000])
    #pragma acc wait
