...
void LoopInfo::print() const
{
    ...
    std::cout << "Indirect Accesses : "
      ...
      std::cout << "Bitwise Count     : " << features.countBitwise << std::endl;
      std::cout << "Int Modulus       : " << features.intModulus << std::endl;
      std::cout << "Float Modulus     : " << features.floatModulus << std::endl;
      ...
      std::cout << "Select Count      : " << features.selectStmtCount << std::endl;
}
